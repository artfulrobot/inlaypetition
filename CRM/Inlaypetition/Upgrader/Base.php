 ...
 */
class CRM_Inlaypetition_Upgrader_Base {

  /**
   * @var CRM_Inlaypetition_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Inlaypetition_Upgrader(
        'inlaypetition',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Inlaypetition_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Inlaypetition_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
